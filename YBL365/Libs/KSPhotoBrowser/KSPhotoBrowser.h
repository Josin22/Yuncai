...
typedef NS_ENUM(NSUInteger, KSPhotoBrowserShowStyle) {
    KSPhotoBrowserShowStylePresent,
    KSPhotoBrowserShowStylePush
};
...
@property (nonatomic, assign) KSPhotoBrowserShowStyle showStyle;
