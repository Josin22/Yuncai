...
#pragma mark  YBLOrderMMTradeHeaderView

@interface YBLOrderMMTradeHeaderView ()

@end

@implementation YBLOrderMMTradeHeaderView
...
- (void)createTradeHeaderView{
    ...
    CGFloat  height = [YBLOrderMMTradeHeaderView getMMTradeHeaderViewHeight];
