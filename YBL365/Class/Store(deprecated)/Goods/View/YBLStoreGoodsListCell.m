...
//    _eventLab.textColor = [UIColor whiteColor];
...
//    _promotionLab.textColor = [UIColor whiteColor];
...
//        make.right.right.top.equalTo(@0);
//        make.height.equalTo(@1);
//        make.left.equalTo(_goodPriceLabel.mas_left);
