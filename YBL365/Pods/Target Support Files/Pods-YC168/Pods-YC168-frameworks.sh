...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/BGDB_OC/BGDB_OC.framework"
  install_framework "$BUILT_PRODUCTS_DIR/FMDB/FMDB.framework"
  install_framework "$BUILT_PRODUCTS_DIR/HMImagePicker/HMImagePicker.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/Wonderful/Wonderful.framework"
