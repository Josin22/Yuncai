...
#pragma mark -  setCurrentIndexPage
#warning custom setCurrentIndexPage!!!!!
- (void)setCurrentIndexPage:(NSInteger)currentIndexPage{
    _currentIndexPage = currentIndexPage;
    if (_currentIndexPage != [self currentIndex]) {
        [_mainView scrollToItemAtIndexPath:[NSIndexPath indexPathForItem:_currentIndexPage inSection:0] atScrollPosition:UICollectionViewScrollPositionNone animated:NO];
    }
}
